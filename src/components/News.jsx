    ...
    <div className='py-16 md:py-20 lg:py-28 xl:py-[150px] container lg:max-w-[1188px] relative z-30'>
      ...
      <div className='flex items-start justify-between gap-4 xl:gap-6 mt-8 max-md:flex-wrap'>
        {NEWS_DATA.map((obj, index) => (
          <div className='rounded-[10px] border border-black shadow-custom border-opacity-10 lg:pb-5 p-3 h-full bg-white max-lg:min-h-0 max-xl:min-h-[451px] md:w-1/2' key={index}>
            <img className='rounded-[10px] object-cover w-full object-center h-[237px] sm:h-[320px] md:h-[280px] lg:h-[247px]' src={obj.imgPath} alt={obj.alt} />
            ...
            <p className='leading-150 mt-2 lg:mt-4 text-light-dark max-sm:text-sm'>{obj.desc}</p>
