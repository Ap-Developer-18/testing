    ...
    <div className='py-16 md:py-20 lg:py-28 xl:py-[150px] container lg:max-w-[1188px] relative z-30'>
      ...
      <div className='flex items-start justify-between gap-4 xl:gap-6 mt-8 max-md:flex-wrap'>
        {NEWS_DATA.map((obj, index) => (
          <div className='rounded-[10px] border border-black shadow-custom border-opacity-10 pb-5 p-3 h-full bg-white max-lg:min-h-0 max-xl:min-h-[451px]' key={index}>
            ...
            <p className='leading-130 text-orange font-medium mt-6'>{obj.readMore}</p>
          </div>
        ))}
      </div>
    </div>
